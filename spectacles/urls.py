...
urlpatterns += patterns('',
    url(r'^connection/$', 'django.contrib.auth.views.login', {'template_name': 'registration/login.html'}, name='connection'),
    url(r'^deconnection/$', 'django.contrib.auth.views.logout', {'next_page': reverse_lazy('accueil')}, name='deconnection'),
